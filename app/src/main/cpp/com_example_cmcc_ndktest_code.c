...
#include "com_example_cmcc_ndktest_code.h"
const char keyValue[] = {
...
jbyteArray Java_com_example_cmcc_ndktest_JniUtils_getKeyValue(JNIEnv *env, jobject obj)
{
...
//JNIEXPORT JNICALL
jbyteArray Java_com_example_cmcc_ndktest_JniUtils_getIv(JNIEnv *env, jobject obj)
{
